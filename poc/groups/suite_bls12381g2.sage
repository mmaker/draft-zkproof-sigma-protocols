...
bls12381g2_svdw_ro = BasicH2CSuite(
    suite_name, bls12381g2_svdw(suite_name, True))
...
bls12381g2_svdw_nu = BasicH2CSuite(
    suite_name, bls12381g2_svdw(suite_name, False))

suite_name = "BLS12381G2_XMD:SHA-256_SSWU_NU_"
bls12381g2_sswu_nu = IsoH2CSuite(
    suite_name, bls12381g2_sswu(suite_name, False))

...
edw25519_sha256_ro = EdwH2CSuite(
    suite_name, edw_suite(suite_name, hashlib.sha256, True))

suite_name = "curve25519_XMD:SHA-256_ELL2_RO_"
monty25519_sha256_ro = MontyH2CSuite(
    suite_name, monty_suite(suite_name, hashlib.sha256, True))

suite_name = "edwards25519_XMD:SHA-256_ELL2_NU_"
edw25519_sha256_nu = EdwH2CSuite(
    suite_name, edw_suite(suite_name, hashlib.sha256, False))

suite_name = "curve25519_XMD:SHA-256_ELL2_NU_"
monty25519_sha256_nu = MontyH2CSuite(
    suite_name, monty_suite(suite_name, hashlib.sha256, False))

suite_name = "edwards25519_XMD:SHA-512_ELL2_RO_"
edw25519_sha512_ro = EdwH2CSuite(
    suite_name, edw_suite(suite_name, hashlib.sha512, True))

suite_name = "curve25519_XMD:SHA-512_ELL2_RO_"
monty25519_sha512_ro = MontyH2CSuite(
    suite_name, monty_suite(suite_name, hashlib.sha512, True))

suite_name = "edwards25519_XMD:SHA-512_ELL2_NU_"
edw25519_sha512_nu = EdwH2CSuite(
    suite_name, edw_suite(suite_name, hashlib.sha512, False))

suite_name = "curve25519_XMD:SHA-512_ELL2_NU_"
monty25519_sha512_nu = MontyH2CSuite(
    suite_name, monty_suite(suite_name, hashlib.sha512, False))
...
def test_suite_25519():
    _test_suite(edw25519_sha256_ro, monty25519_sha256_ro,
                m2e_25519, group_order)
    _test_suite(edw25519_sha256_nu, monty25519_sha256_nu,
                m2e_25519, group_order)
    _test_suite(edw25519_sha512_ro, monty25519_sha512_ro,
                m2e_25519, group_order)
    _test_suite(edw25519_sha512_nu, monty25519_sha512_nu,
                m2e_25519, group_order)
    ...
    _test_suite(EdwH2CSuite(suite_name, edw_suite(suite_name, hashlib.sha512, True)),
                MontyH2CSuite(suite_name, monty_suite(
                    suite_name, hashlib.sha512, True)),
